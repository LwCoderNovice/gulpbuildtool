...
$.ZPFnName = function(fn) {
  return fn.name || (fn + '').split(/\s|\(/)[1];
};

$.ZPInit = function(fn, name, set = true) {
  window.ZP = window.ZP || {};
  window.ZP.apps = window.ZP.apps || {};
  if (fn && set) {
    name = name || $.ZPFnName(fn);
    return window.ZP.apps[name] = fn;
  }
};

$.ZPPluggin = function(fn, name, bypass = false, elPluggin = true) {
  var obj;
  obj = {};
  $.ZPInit(fn, name, true);
  name = name || $.ZPFnName(fn);
  obj[name] = function(option, ...args) {
    this.each(function() {
      var $this, data, key;
      $this = $(this);
      key = 'zp-' + name;
...
// helper
require('./helper/zp-pluggin.coffee');

// modules
require('./helper/zp-module.coffee');

require('./modules/ready.coffee');

require('./modules/carousel.coffee');
...
},{}],"slick":[function(require,module,exports){
module.exports=require('sVUmsQ');
},{}],"sVUmsQ":[function(require,module,exports){
(function (global){
...
; browserify_shim__define__module__export__(typeof slick != "undefined" ? slick : window.slick);
